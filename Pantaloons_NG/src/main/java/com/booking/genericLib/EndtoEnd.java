...
import com.booking.pagerepository.ZZZContactDetailsPage;
import com.booking.pagerepository.ZZZFlightPage;
import com.booking.pagerepository.ZZZPassengerInfoPage;
import com.booking.pagerepository.ZZZSpicejetHomePage;

@Listeners(com.booking.genericLib.ListenerImp.class)
public class EndtoEnd extends Base
{
	FileLib lib = new FileLib();
	ZZZSpicejetHomePage shome;
	ZZZContactDetailsPage cd;
	ZZZFlightPage fp;
	ZZZPassengerInfoPage pip;
	
	@Test
	
	public void bookingTicket() throws Throwable
	{
		shome = PageFactory.initElements(driver, ZZZSpicejetHomePage.class);
		cd = PageFactory.initElements(driver, ZZZContactDetailsPage.class);
		fp = PageFactory.initElements(driver, ZZZFlightPage.class);
		pip = PageFactory.initElements(driver, ZZZPassengerInfoPage.class);
